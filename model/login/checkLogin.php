		...
		if(!empty($loginUsername) && !empty($loginUsername)){
			...
			if($checkUserStatement->rowCount() > 0){
				...
				if($_SESSION['role'] == 'admin'){
					...
					echo '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>Login success! Redirecting you to user page...</div>';
					header('Location: ../../userpage.php');  // Adjust this path as needed
					exit();
				}
			} else {
