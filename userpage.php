	  ...
	  <div class="row">
		...
		<div class="image-container"><img src="screenshots/logo.jpg" alt="Description of the image"></div>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="false">Equip_Recived</a>
			  <a class="nav-link" id="v-pills-purchase-tab" data-toggle="pill" href="#v-pills-purchase" role="tab" aria-controls="v-pills-purchase" aria-selected="false">Equip_Rwquest</a>
			...
			<div class="tab-content" id="v-pills-tabContent">
			  <div class="tab-pane fade show active" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Equipment_Arrived</div>
				  <div class="card-body">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemDetailsTab">Equip_Arrived</a>
						</li>
					</ul>
						...
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form>
							  ...
							  <div class="form-row">
								...
								<div class="form-group col-md-3">
								  <label for="itemDetailsTotalStock">Tag_Numberk</label>
							  ...
							  <button type="button" id="addItem" class="btn btn-success">Recieve Item</button>
							  <button type="button" id="updateItemDetailsButton" class="btn btn-primary">Reject</button>
